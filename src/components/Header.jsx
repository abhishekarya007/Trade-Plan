        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-3.5">
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
              ...
              {/* View Switcher Tabs (Ledger, Calendar, Analytics) */}
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <button
                ...
                className="bg-[#111622] hover:bg-slate-800/80 text-amber-300 border border-slate-800 hover:border-slate-700 px-2.5 py-1.5 rounded-xl text-xs font-medium flex items-center gap-1.5 transition-all"
